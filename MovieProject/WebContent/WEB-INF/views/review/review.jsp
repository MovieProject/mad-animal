					...
					<c:if test="${ not empty requestScope.reviewList }">
						<c:forEach items="${ requestScope.reviewList }" var="review">
							...
							<c:if
								...
								<tr>
									<th>한줄평</th>
									<td class="oneline" colspan="5"><script>
										contentMaxLength('${ review.contents }');
									</script></td>
								</tr>
							</c:if>
							<c:if
								...
								<tr>
									<th>한줄평</th>
									<td class="oneline" colspan="4">${ review.contents }</td>
