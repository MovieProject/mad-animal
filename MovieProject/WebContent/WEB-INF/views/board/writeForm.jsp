	...
	<div id="page">
		...
		<div id="content">
			<form name="writeForm" action="write" method="POST"  >
				<table id="noticewritetable" class="maintable">
					<caption>공지사항 쓰기</caption>
					<thead>
						<tr>
							<th>제 목</th>
						...
						<tr>
							<th>작성자</th>
							<td><input class="writerinput" type="text" name="writer"  size="20" maxlength="20" value='${loginMember.memberName}' readonly="readonly"></td>
						</tr>
					</thead>
					<tbody>
						<tr>
