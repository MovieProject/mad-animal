		...
		<div class="boardpage">
			...
			<table id="headertable" class="headertable">
				<tr>
					...
					<td><a href="<c:url value="/member_Recommend.jsp"/>">회원추천</a>
						|</td>
				...
				<tr>
					<td colspan="5" id="search"><input type="text"
						name="searchtext" id="searchtext" placeholder="검색어 입력"> <a
						href="<c:url value="/search.jsp"/>"><input type="button"
							name="searchbutton" id="searchbutton" value="검색"></a></td>
				</tr>
			</table>
		</div>
	</div>
