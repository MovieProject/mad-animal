...
<body>
	...
	<div id="page">
		...
		<div id="content">
			...
			<form name="writeForm"
				action="update?num=${board.num}&searchType=${param.searchType}&searchText=${param.searchText}&pageNumber=${currentPageNumber}"
				method="POST">
					...
					<thead>
						<tr>
							...
							<td><input class="titleinput" type="text" name="title"
								size="20" maxlength="50">${movie.contents}</td>
						</tr>
						<tr>
							<th>장르</th>

							<td><input class="writerinput" type="text" name="writer"
								size="20" maxlength="20">${movie.contents}</td>
				...
				<div class="buttonbar">
					...
					<input type="button" value="취소"
						onclick="goUrl('read?num=${board.num}&searchType=${param.searchType}&searchText=${param.searchText}&pageNumber=${currentPageNumber}');">
				</div>
			</form>
