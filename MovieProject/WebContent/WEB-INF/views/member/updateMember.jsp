			...
			<form action=" <c:url value ='/member/update&memberID=${sessionScope.loginMember.memberID }&grade=${sessionScope.loginMember.grade }'/>" method="POST">
				<table class="registertable">
					...
					<tr>
						...
						<td><input type="text" name="name" size="20" maxlength="20" value = "${sessionScope.loginMember.memberName }"></td>
					</tr>
					<tr>
						<td class="label">나이 :</td>
						<td><input type="text" name="age" size="30" maxlength="60"value = "${sessionScope.loginMember.age }"></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td><input type="text" name="email" size="20" maxlength="20"value = "${sessionScope.loginMember.email }"></td>
					</tr>
					<tr>
						<td class="label">전화번호 :</td>
						<td><input type="text" name="tel" size="20" maxlength="20"value = "${sessionScope.loginMember.tel }"></td>
					</tr>
					<tr>
						<td colspan="2">
					</tr>
