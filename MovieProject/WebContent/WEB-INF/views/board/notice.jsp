				...
				<form name="searchForm" action="list" method="GET"
					...
					<select name="searchType">
						...
						<option value="board_title"
							<c:if test="${param.searchType == 'board_title'}"> selected="selected"</c:if>>제목</option>
						<option value="board_writer"
							<c:if test="${param.searchType eq 'board_writer'}"> selected="selected"</c:if>>글쓴이</option>
						<option value="board_contents"
							<c:if test="${param.searchType == 'board_contents'}"> selected="selected"</c:if>>내용</option>
					</select>
