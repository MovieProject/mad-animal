...
<table class="prevmaintable">
	<caption id="preboardtitle">회원추천 영화</caption>
	<thead>
		<tr>
		...
		<c:choose>
			...
			<c:otherwise>
				<c:forEach var="movie" items="${requestScope.movielist}" end="1">
					<tr>
						<td class="previewTitle"><a href="movieRead?pageNumber=${currentPageNumber}&num=${movie.movieNum}&searchType=${param.searchType}&searchText=${param.searchText}&type=1" target="_parent">${movie.movieName}</a></td>
